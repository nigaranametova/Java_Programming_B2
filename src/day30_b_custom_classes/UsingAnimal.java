...
public class UsingAnimal {
    public static void main(String[] args) {
        ...
        // If we want to print out the object directly, we MUST declare day36_inheritance.app.access.day36_inheritance.access.a.a method called .toString() in the class
